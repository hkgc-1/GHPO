...
@dataclass
class GHPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`GHPOTrainer`].

    Only the parameters specific to GHPO training are listed here. For details on other parameters, refer to the
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`GHPOTrainer`] is provided as a string.
